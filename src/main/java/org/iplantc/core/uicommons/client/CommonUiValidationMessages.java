 ...
 * 
 */
public interface CommonUiValidationMessages extends Messages {
     ...
     */
    String notValidDoubleMsg(String field, Double low, Double high);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String notValidDoubleAboveMsg(String field, Double bottom);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String notValidDoubleBelowMsg(String field, Double bottom);
     ...
     * @return a parameterized string representing the message shown when the field is not valid.
     */
    String notValidIntegerMsg(String field, Integer low, Integer high);
     ...
     * @return a parameterized string representing the message shown when the field is not valid.
     */
    String notWithinRangeMsg(String field, Number low, Number high);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String notValidIntegerAboveMsg(String field, Integer bottom);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String notAboveValueMsg(String field, Integer bottom);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String notAboveValueMsg(String field, Double bottom);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String notBelowValueMsg(String field, Double bottom);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String nonEmptyArrayMsg(String field);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String nonEmptyClassMsg(String field);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String nonValidGenotypeNameMsg(String field);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String invalidFilenameMsg(String field);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String fieldLessThanMsg(String field, String fldDependant);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String fieldGreaterThanMsg(String field, String fldDependant);
     ...
     * @return a parameterized string representing the message shown when the field is not valid.
     */
    String nonValidClipperDataMsg(String field);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String notValidIntegerBelowMsg(String name, int bottom);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String notBelowValueMsg(String name, int bottom);
     ...
     * @return a parameterized string representing the message shown when the field is not valid
     */
    String invalidCharacterMsg(String name, String invalidCharacterSet);
